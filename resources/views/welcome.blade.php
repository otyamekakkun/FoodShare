{{--
   welcome.blade.phpのファイル
   (使用はトップ画面ファイル)
1 デフォルトでlaravel ログイン registerが出ているのでそれを削除する
2 web用で今回はボタンを４つ準備する(
    a:利用者のログインページにいける。
    b:利用者のユーザー登録ページに飛ばすことができる。
    c:コンビニスタッフのログインページいける。
    d:コンビニスタッフのユーザー登録ページにいける。
)
3 写真を挿入する
4
5
